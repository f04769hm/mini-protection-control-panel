...
Preferred controller: Arduino Opta.

Reason: DIN-mount form factor, industrial presentation, 24 V-friendly I/O and strong link to current industrial-control/Finder work.

Fallback controller: Raspberry Pi 4.
